...
class TactileSystem:
    ...
    def edge_photo_all(self, width3, height3):
        n = 0
        ori_path = "/Users/williamfisilo/Desktop/Tactilesys/Tactile_backend/data/temp/undetected"
        result_dir = "/Users/williamfisilo/Desktop/Tactilesys/Tactile_backend/data/temp/detected"
        try:
            for image in os.listdir(ori_path):
                ...
                if image is None:
                    break
                undetected = os.path.join("/Users/williamfisilo/Desktop/Tactilesys/Tactile_backend/data/temp/undetected", image)
                print(undetected)
                detected = self.edge_photo(undetected, width3, height3)
                cv2.imwrite(os.path.join(result_dir, f'{n}.jpg'), detected)
                n+=1
            print("DONE!")
